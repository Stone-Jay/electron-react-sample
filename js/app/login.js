...
class Login extends React.Component {
    ...
    login(e) {
        ...
        ipcRenderer.send('loginCheck', {userName: user.userName, password: user.password});

    }
    render() {
        return ( < div className = "panel panel-info" >
            < div className = "panel-heading" > Login < /div> < div className = "panel-body" >
            ...
            disabled = {
                this.state.username.length === 0 || this.state.pwd.length < 6
            }
            value = "Login" / >
...
class LoginNav extends React.Component {
    ...
    render() {
        return ( < div className = "navbar navStyle" >
            ...
            style = {{color: "white"}} > < span className = "glyphicon glyphicon-remove"
            aria-hidden = "true" > < /span></a >

            < a href = "#"
            onClick = {
                this.toggleDevTool.bind(this)
            }
            style = {{color: "white", textDecoration: "none"}} > < span className = "glyphicon glyphicon-wrench"
            aria-hidden = "true" > < /span></a >
            < /div>
        );
    }
